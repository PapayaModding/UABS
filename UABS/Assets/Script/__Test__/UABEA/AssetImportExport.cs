...
namespace UABS.Assets.Script.__Test__.UABEA
{
    public class AssetImportExport
    {
        ...
        public static AssetsReplacer CreateAssetReplacer(long pathID, int classID, ushort MonoID, byte[] data)
        {
            return new AssetsReplacerFromMemory(pathID, classID, MonoID, data);
        }
